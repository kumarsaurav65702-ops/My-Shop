...
const Home = () => {
  return (
    <>    <div
  className="h-screen bg-cover bg-no-repeat bg-position-[center_right_-11rem] overflow-hidden sm:bg-position-[center_right_-8rem] relative z-0 flex  "
...
>
 ...
 <button className='bg-red-900 px-7 text-l py-2 flex gap-3 rounded-2xl active:scale-95 m-4'>Products<ShoppingBag size={22} /></button></div>
...
{/* for sm */}
 ...
 <button className='bg-red-900 px-9 text-xl py-4 flex gap-3 rounded-2xl active:scale-95 m-4'>Products<ShoppingBag size={29} /></button></div>
{/* for sm */}
...
{/* for lg */}
 <div className='text-white  bg-transparent z-10 h-20 rounded-2xl mt-30 ml-20     items-center justify-around w-62 font-bold flex-col absolute hidden sm:hidden md:hidden lg:flex xl:hidden 2xl:hidden'><h1 className='font-bold text-5xl text-yellow-400'>ShopSmart</h1>
 <button className='bg-red-900 px-9 text-xl py-4 flex gap-3 rounded-2xl active:scale-95 m-4'>Products<ShoppingBag size={29} /></button></div>
{/* for lg */}
